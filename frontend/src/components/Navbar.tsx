          ...
          {!loading && isAuthenticated && user && (
            <div className="relative" ref={dropdownRef}>
              ...
              {profileOpen && (
                <div
                  role="menu"
                  className="absolute right-0 top-full mt-2 w-64 z-[99999] rounded-2xl border border-white/10 bg-slate-900 p-2 shadow-2xl shadow-black/80 backdrop-blur-xl"
                >
