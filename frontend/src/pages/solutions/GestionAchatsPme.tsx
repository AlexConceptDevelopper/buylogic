...
const CATALOGUE_FICTIF: Product[] = [
  {
    id: "1",
    name: "Kit Liaison Frigorifique 1/4 - 3/8 (5m)",
    ref: "SANI-LIAISON-5M",
    price: 42.5,
    unit: "SET",
    minQty: 5,
  ...
  {
    id: "2",
    name: "Gaine Isolante Flexible Ø 160 mm (10m)",
    ref: "SANI-GAINE-160",
    price: 28.0,
    unit: "MTR",
    minQty: 2,
  ...
  {
    id: "3",
    name: "Bouteille Fluide R32 (9.5kg)",
    ref: "SANI-R32-9.5",
    price: 145.0,
    unit: "BTE",
    minQty: 1,
...
export default function GestionAchatsPme() {
  ...
  const [orderNumber] = useState(
    `BC-2026-${Math.floor(100 + Math.random() * 900)}`,
  );
  ...
  const totalGeneral = orderItems.reduce(
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Centralisez vos fournisseurs et éditez vos bons de commande PDF en un clic. Découvrez le logiciel de gestion des achats simple et pensé pour les PME."
        />
        <link
          rel="canonical"
          href="https://buylogic.fr/solutions/gestion-achats-pme"
        />

        {/* Open Graph / Réseaux sociaux */}
        <meta
          property="og:title"
          content="Logiciel de Gestion des Achats PME : Commandes & Fournisseurs | BuyLogic"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://buylogic.fr/solutions/gestion-achats-pme"
        />
        ...
        <div className="mx-auto max-w-6xl px-6 py-12">
          ...
          <div className="mb-10 text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-300 leading-relaxed">
              Centralisez vos fournisseurs, éditez des bons de commande propres
              en 2 clics et testez notre simulateur ci-dessous pour voir la
          ...
          <div className="my-12 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] items-start">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-white/10 bg-slate-900/80 p-6 backdrop-blur-md shadow-xl space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      <option value="SaniChauffage Diffusion">
                        SaniChauffage Diffusion
                      </option>
                      <option value="Brossette Thermique">
                        Brossette Thermique
                      </option>
              ...
              <div className="rounded-2xl border border-white/10 bg-slate-900/80 p-6 backdrop-blur-md shadow-xl space-y-4">
                <h2 className="text-sm font-bold text-white uppercase tracking-wider">
                  2. Catalogue du fournisseur
                </h2>
                <p className="text-xs text-slate-400">
                  Cliquez sur "Ajouter" pour inclure un produit dans la
                  commande.
                </p>
              ...
              <div className="rounded-2xl border border-white/10 bg-slate-900/80 p-6 backdrop-blur-md shadow-xl space-y-4">
                ...
                {orderItems.length === 0 ? (
                  <p className="text-xs text-slate-500 italic py-4 text-center">
                    Aucun article sélectionné. Ajoutez des produits depuis le
                    catalogue ci-dessus.
                  </p>
                ) : (
                  <div className="space-y-4">
                    {orderItems.map((item) => (
                      <div
                        key={item.id}
                        className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl bg-slate-950 border border-white/5"
                      >
                        ...
                        <div className="flex items-center gap-4 justify-between sm:justify-end">
                          <div>
                            ...
                            <span className="text-[9px] text-slate-500 block mt-0.5">
                              Min requis : {item.minQty} {item.unit}
                            </span>
                          </div>
                  ...
                  <div className="overflow-x-auto mb-6">
                    <table className="w-full text-xs text-left">
                      ...
                      <tbody className="divide-y divide-slate-100">
                        {orderItems.map((item) => (
                          <tr key={item.id}>
                            <td className="py-2.5 font-medium text-slate-800 max-w-30 truncate">
                              {item.name}
                            </td>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="space-y-4">
              ...
              <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
                Dans une PME, le temps passé à jongler entre des tableaux Excel,
                des e-mails éparpillés et des bons de commande papier est
                colossal. Sans centralisation, les conséquences pèsent
                lourdement sur la rentabilité :
              </p>
              <ul className="space-y-2 text-slate-300 list-disc list-inside text-sm pl-2">
                <li>
                  <strong className="text-white">
                    Des erreurs de références :
                  </strong>{" "}
                  Transmettre un code article erroné à un distributeur retarde
                  les chantiers et bloque l'approvisionnement.
                </li>
                <li>
                  <strong className="text-slate-200">
                    Des dérives tarifaires :
                  </strong>{" "}
                  L'absence d'historique des prix d'achat empêche de repérer les
                  hausses de tarifs injustifiées appliquées par les
                  fournisseurs.
                </li>
                <li>
                  <strong className="text-slate-200">
                    Un suivi de livraison aveugle :
                  </strong>{" "}
                  Ne pas savoir précisément ce qui a été commandé, validé ou
                  reçu crée des tensions internes et des retards de facturation.
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
                Les PME n'ont pas besoin d'un ERP lourd, complexe et hors de
                prix taillé pour des multinationales. Notre solution a été
                pensée pour aller droit au but et structurer vos processus
                d'achats en quelques minutes :
              </p>
              <div className="grid gap-4 sm:grid-cols-3 pt-2">
                <div className="rounded-xl border border-white/10 bg-slate-900/60 p-5">
                  ...
                  <p className="text-xs text-slate-400 leading-relaxed">
                    Retrouvez instantanément les coordonnées, les catalogues et
                    les conditions négociées avec chaque fournisseur.
                  </p>
                </div>
                <div className="rounded-xl border border-white/10 bg-slate-900/60 p-5">
                  <h3 className="font-bold text-white mb-2 text-sm">
                    Bons de commande pros
                  </h3>
                  <p className="text-xs text-slate-400 leading-relaxed">
                    Générez des PDF structurés à votre image, conformes et prêts
                    à être envoyés en un seul clic.
                  </p>
                </div>
                <div className="rounded-xl border border-white/10 bg-slate-900/60 p-5">
                  <h3 className="font-bold text-white mb-2 text-sm">
                    Contrôle des minimums
                  </h3>
                  <p className="text-xs text-slate-400 leading-relaxed">
                    Respectez automatiquement les conditionnements et les seuils
                    de commande exigés par vos distributeurs.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
                ...
                Pas besoin de semaines de formation. L'interface est fluide,
                ergonomique et conçue pour que vos collaborateurs soient
                autonomes dès le premier jour.
                <br />
                <strong className="text-white">
                  Zéro double saisie :
                </strong>{" "}
                Fini de réécrire les mêmes informations d'un fichier à l'autre.
                Tout est interconnecté pour sécuriser vos flux de trésorerie et
                vos stocks.
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 rounded-2xl border border-white/10 bg-slate-900/80 p-8 text-center backdrop-blur-md shadow-2xl max-w-3xl mx-auto">
            <h3 className="text-xl font-bold text-white mb-3">
              En finir avec les erreurs de commande sur Excel
            </h3>
            <p className="text-sm text-slate-400 mb-6">
              Centralisez vos catalogues, sécurisez vos minimums de commande et
              gagnez un temps précieux au quotidien.
            </p>
            <Link
              to="/login"
